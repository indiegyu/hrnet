...
exp_name = './saved_exp_results/SHHA_vis_test_results'
# pred_file = 'NPWU_HR_Net_val.txt'
pred_file = './saved_exp_results/SHHA_HR_Net_test.txt'

flagError = False
# id_std = [i for i in range(3110,3610,1)]
id_std = [i for i in range(301,482,1)]
# id_std[59] = 3098
...
def main():
    ...
    for i_sample in id_std:
        ...
        img = cv2.imread(img_path + '/' + '0' + str(i_sample) + '.jpg')
